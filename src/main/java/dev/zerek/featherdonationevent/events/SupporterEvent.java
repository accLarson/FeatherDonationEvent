...
public class SupporterEvent extends Event {
    ...
    public SupporterEvent(String purchaserName, String purchaserUuid, String username, String id, String packageName, String price){
